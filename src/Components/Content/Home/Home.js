    ...
    return (
        <div>
            <ul className="list-books">
                ...
                <CardBooks nameBook="Cinderela" src={Cinderela} alt="Cinderela" classGenero="Infantil" genero="Infantil" 
                ...
                <CardBooks nameBook="A bela e a fera" src={BelaFera} alt="A bela e a fera" classGenero="Infantil" genero="Infantil" 
                ...
                <CardBooks nameBook="Chapeuzinho Vermelho" src={Chapeuzinho} alt="Chapeuzinho Vermelho" classGenero="Infantil" genero="Infantil" 
                ...
                <CardBooks nameBook="O pequeno príncipe" src={PequenoPrincipe} alt="Chapeuzinho Vermelho" classGenero="Infantil" genero="Infantil" 
